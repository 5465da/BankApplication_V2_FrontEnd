...
export default function BodyContainer() {
  ...
  const handleSubmit = () => {
    ...
    var config = {
      ...
      data: JSON.stringify({ "payment_type": "Tax", "card": state.mobilePayment.creditCard.card_id, "payment_amount": state.mobilePayment.amount })
    };
  ...
  const formFrom = (
    <div className="fromForm fromFormConfirmation">
      <h1>From</h1>
      <p>{state.taxPayment.creditCard.card_type}</p>
      <div>
        <Button
          id="submitButton"
          variant="contained"
